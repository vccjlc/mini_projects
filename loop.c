/**
 * @file        loop.c
 * @brief       Program to interpret and execute "Loop" language code.
 *
 * This program reads and executes code written in the "Loop" programming
 ...
 * left.
 *
 * "Loop" code is read in segments (called "partitions") delineated by
